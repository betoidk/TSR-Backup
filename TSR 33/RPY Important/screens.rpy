...
screen murdoch_select():
    vbox:
        grid 3 2:
            ...
            null
        add "sprites/murdoch/mur.webp" xpos 800 xysize(800, 800) ypos -400 alpha 0.55
...
screen cliff_select():
    vbox:
        grid 3 2:
            ...
            null
        add "sprites/cliff/cli.webp" xpos 900 xysize(600, 700) ypos -300 alpha 0.55
...
init python:
    ...
    journal_entries = [
        {
            "text": "{color=#000000}{font=willfont.ttf}Huxley Greene is dead. His body was found frozen. Decapitated with ripping force.{/font}{/color}",
            "image": "wn1",
        },
        {
            "text": "{color=#000000}{font=willfont.ttf}Where was the body found? ASK TODD LATER. {/font}{/color}",
            "image": "wn2",
        },
        {
            "text": "{color=#000000} {font=willfont.ttf}Cliff claims Reed tries to break into his apartment.{/font} {/color}",
            "image": "wn3",
        },
        {
            "text": "{color=#000000}{font=willfont.ttf}Cliff works with James for CSCG.{/font}{/color}",
            "image": "wn4",
        },
        {
            "text": "{color=#000000}{font=willfont.ttf}Cliff's real name is Cornelis. He claims he does not have his worker's permit.{/font} {/color}",
            "image": "wn5",
        },
        {
            "text": "{color=#000000}{font=willfont.ttf}[stagnighttext]{/font}{/color}",
            "image": "wn6",
        },
        {
            "text": "{color=#000000}{font=willfont.ttf}[chnighttext]{/font}{/color}",
            "image": "wn6",
        },
        {
            "text": "{color=#000000}{font=willfont.ttf}[huxley1]{/font}{/color}",
            "image": "wn7",
        },
        {
            "text": "{color=#000000}{font=willfont.ttf}[huxley2]{/font}{/color}",
            "image": "wn14",
        },
        {
            "text": "{color=#000000}{font=willfont.ttf}[huxley3]{/font}{/color}",
            "image": "todddumb",
        },
        {
            "text": "{color=#000000}{font=willfont.ttf}[jamestext]{/font}{/color}",
            "image": "[jamesimage]",
        },
        {
            "text": "{color=#000000}{font=willfont.ttf}[changtext]{/font}{/color}",
            "image": "wn11",
        },
        {
            "text": "{color=#000000}{font=willfont.ttf} Sam needs to sleep more. [cynthiatext]{/font}{/color}",
            "image": "wn12",
        },
        {
            "text": "{color=#000000}{font=willfont.ttf}[harlantext]{/font}{/color}",
            "image": "wn13",
        },
        {
            "text": "{color=#000000}{font=willfont.ttf}[etheltext]{/font}{/color}",
            "image": "todddumb",
        },
        {
            "text": "{color=#000000}{font=willfont.ttf}[huxley4]{/font}{/color}",
            "image": "wn2",
        },
        {
            "text": "{color=#000000}{font=willfont.ttf}[gumtext]{/font}{/color}",
            "image": "wn16",
        },
        {
            "text": "{color=#000000}{font=willfont.ttf}[kanetext]{/font}{/color}",
            "image": "wn17",
        },
        {
            "text": "{color=#000000}{font=willfont.ttf}[filmtext]{/font}{/color}",
            "image": "wn18",
        },
        {
        ...
        {
            "text": "{color=#000000}{font=willfont.ttf}Her eyes widen and I see the pushy attitude slip away.{/font}{/color}",
            "image": "notegre",
        },
        {
            "text": "{color=#000000}{font=willfont.ttf}[portraittext]{/font}{/color}",
            "image": "noteportrait",
        },
        {
            "text": "{color=#000000}{font=willfont.ttf}[manortext]{/font}{/color}",
            "image": "notemirror",
        },
        {
            "text": "{color=#000000}{font=willfont.ttf}It looks like James wants to remove the power of Federal currency in Echo and replace it with CSCG redemption slips.{/font}{/color}",
            "image": "notejamesbucks",
        },
        {
            "text": "{color=#000000}{font=willfont.ttf}[hledgertext]{/font}{/color}",
            "image": "ledger",
        },
        {
            "text": "{color=#000000}{font=willfont.ttf}[hlettertext]{/font}{/color}",
            "image": "lettoir",
        },
        {
