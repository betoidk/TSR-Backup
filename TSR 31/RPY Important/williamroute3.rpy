...
show sam talking at center,dark2 with dissolve
...
m "\"There. All done.\""
show sam annoyed n with dis1
show sam eyes smile n with dis1
show sam annoyed n with dis
...
show sam eyes smile n with dis
hide sam with dissolve
pause 0.45
show sam s at center,night with dissolve
...
show sam talking s with dis
m "\"Nah.\""
show sam annoyed s with dis
stop sound
wi "\"Then hurry up. I have to lock the door behind me.\""
show sam annoyed with dis3
...
if  STAGNIGHT_Points > 0:
    ...
    wi "\"That you, Nik?\""
    show nik at center,night with dissolve
...
menu williamstagmenu:
    ...
    "Check the upper beams" if willstag1interview == False:
        ...
        if willstag1interview2 == False and STAGNIGHT_Points > 0:
            show nik talking at center,light1 with dis3
        ...
        menu willstagmenu2:
            ...
            "Talk to the miners." if willstag2interview2 == False and STAGNIGHT_Points > 0:
                ...
                $ BG_Light =2
                $ MININT_Points +=1
                show nik at center,stagback with dissolve
...
play background ("music/cicadas.mp3") fadein 2.5
play sound ("sfx/gravelwalk.ogg")
...
#sfx
play music ("music/acastle.mp3") fadein 3.0
...
show mrs eyes with dis
show nik eyes talking with dis3
...
play music ("music/contemplation.ogg") fadein 3.0
show nik at center,dark3 with dis3
...
stop music fadeout 3.0
scene bg black with dissolve
play background ("music/cicadas.mp3") fadein 4.5
...
m "\"Oh.\""
show sam surprised with dis1
show sam surprised talking with dis
m "\"Well if it isn’t...\""
show sam sad with dis1
show sam sad talking with dis
...
if ETHINT_Points == 1 or HARINT_Points == 1:
    ...
    wi "\"We’re done.\""
    show cyn serious a with dis3
    play sound ("sfx/clothrustle.mp3")
...
show sam smile with dis
cl "\"{i}Creative{/i} my foot, I ought to shake you!\""
show sam surprised with dis
show cli doubt with dis3
...
if ETHINT_Points == 1 or HARINT_Points == 1:
    ...
    $ hledgertextes = "Names. Addresses. Companions. I could probably track down half the city with all of this information."
...
play background ("sfx/crowd.mp3") fadein 6.0
...
if ETHINT_Points == 1 or HARINT_Points == 1:
    show sam at center,saloon with dis3
...
play music ("music/a-moment-of-solace.mp3") fadein 3.0
...
show sam eyes at center,dusk with dis3
...
show mur eyes with dis3
hide tod
show sam annoyed at halfleft,nightbrown
with dis3
m "\"Boo.\""
show sam surprised with dis3
show mur smile with dis3
...
show sam at left,night with dis:
    xzoom-1
...
show sam at center,night with dis3
...
play music ("music/stag1.mp3") fadein 4.0
scene stagnight with dissolve
...
if ETHINT_Points == 1 or HARINT_Points == 1:
    ...
    show nik at stagback behind yao with dis3:
        xpos 0.55
    show cha with dis3
...
show sam at center,light1 with dissolve
show sam talking with dis
...
show sam eyes at center,night with dissolve
show sam eyes talking with dis
...
if SW_Points>=3:
    ...
    show sam at centerleft,light1 with dis3:
        xzoom-1
    ...
    show kan wink with dis1
    show kan smile with dis1
    show sam at centerleft,light1 with dissolve:
        xzoom-1
    show sam talking with dis
    ...
    menu willkanechoice:
        ...
        "Yes." if KaneChoice == True:
            ...
            show sam annoyed s at light2 behind tod with dis3:
                xzoom-1
                xpos -0.1
            "Sam rolls his eyes."
            show tod surprised at centerleft,light2 with dis3:
